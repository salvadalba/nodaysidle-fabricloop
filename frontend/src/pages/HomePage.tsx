    ...
    <div className="space-y-16 bg-pattern">
      ...
      <section className="text-center py-16">
        <h1 className="text-5xl font-bold text-white mb-6">
          Sustainable Textile <span className="text-primary">Marketplace</span>
        </h1>
      ...
      <section className="grid md:grid-cols-3 gap-6">
        ...
        <div className="glass-card card-hover p-6">
          <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4 bg-secondary/10">
        ...
        <div className="glass-card card-hover p-6">
          <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4 bg-tertiary/10">
